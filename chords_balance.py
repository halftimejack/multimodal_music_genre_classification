...
INPUT_FILE = 'chord_data_for_training.csv'
OUTPUT_FILE = 'chords_balanced.csv'

SAMPLES_PER_GENRE = 7350
...
try:
    ...
    print("\nCounts per genre:")
    print(balanced_df['simple_genre'].value_counts())
